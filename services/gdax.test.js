...
test('products', async t => {
  ...
  t.deepEqual(productIds.sort(), ['BCH-BTC', 'BCH-EUR', 'BCH-GBP', 'BCH-USD', 'BTC-EUR', 'BTC-GBP', 'BTC-USD', 'ETC-BTC', 'ETC-EUR', 'ETC-GBP', 'ETC-USD', 'ETH-BTC', 'ETH-EUR', 'ETH-GBP', 'ETH-USD', 'LTC-BTC', 'LTC-EUR', 'LTC-USD', 'ZRX-BTC', 'ZRX-EUR', 'ZRX-USD'])
})
